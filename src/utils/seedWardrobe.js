...
const ALL_ITEMS = [
  ...
  // ── MORE TRADITIONAL ──────────────────────────────────────────────────
  { name:"Gold Kanjivaram Silk Saree",      category:"traditional", type:"saree",        color:"gold",      purchasePrice:35000, size:"Free size", brand:"Kanjivaram",  description:"Opulent gold Kanjivaram with heavy zari. Weddings & grand occasions.",                imageUrl: ph("fbbf24","Gold\nKanjivaram") },
  { name:"Purple Silk Saree",               category:"traditional", type:"saree",        color:"purple",    purchasePrice:18000, size:"Free size", brand:"Kanjivaram",  description:"Royal purple silk with gold border. Festive & cultural events.",                    imageUrl: ph("8b5cf6","Purple\nSilk Saree") },
  { name:"Pink Anarkali Suit",              category:"traditional", type:"anarkali",     color:"pink",      purchasePrice:8999,  size:"M",         brand:"Biba",        description:"Flared Anarkali with embroidery. Festive & family occasions.",                     imageUrl: ph("f9a8d4","Pink\nAnarkali Suit") },
  { name:"Teal Salwar Kameez",              category:"traditional", type:"salwar-kameez",color:"teal",      purchasePrice:5999,  size:"M",         brand:"W",           description:"Elegant teal salwar set. Office & casual festive.",                                imageUrl: ph("0d9488","Teal\nSalwar Kameez") },
  { name:"White Cotton Kurti",              category:"traditional", type:"kurti",        color:"white",     purchasePrice:2499,  size:"M",         brand:"Fabindia",    description:"Chikankari embroidered kurti. Daily wear & casual occasions.",                     imageUrl: ph("f8f8f8","White\nCotton Kurti") },
  { name:"Navy Blue Lehenga",               category:"traditional", type:"lehenga",      color:"navy",      purchasePrice:35000, size:"M",         brand:"Ritu Kumar",  description:"Regal navy lehenga with silver embroidery. Weddings & receptions.",               imageUrl: ph("0b1f3a","Navy Blue\nLehenga") },
  // ── MORE DRESSES ──────────────────────────────────────────────────────
  { name:"White Sundress",                  category:"dress",       type:"sundress",     color:"white",     purchasePrice:3999,  size:"S",         brand:"Zara",        description:"Flowy white sundress. Beach & summer casual.",                                     imageUrl: ph("f8f8f8","White\nSundress") },
  { name:"Burgundy Midi Dress",             category:"dress",       type:"midi-dress",   color:"burgundy",  purchasePrice:6499,  size:"M",         brand:"Zara",        description:"Rich burgundy midi. Parties & formal dinners.",                                    imageUrl: ph("991b1b","Burgundy\nMidi Dress") },
  { name:"Rose Gold Sequin Gown",           category:"dress",       type:"evening-gown", color:"rose-gold", purchasePrice:14999, size:"M",         brand:"AND",         description:"Shimmering sequin gown. New Year parties & celebrations.",                        imageUrl: ph("f9a8d4","Rose Gold\nSequin Gown") },
  // ── MORE TOPS ─────────────────────────────────────────────────────────
  { name:"Burgundy Turtleneck",             category:"top",         type:"sweater",      color:"burgundy",  purchasePrice:4999,  size:"M",         brand:"Zara",        description:"Classic turtleneck. Winter & smart casual.",                                       imageUrl: ph("991b1b","Burgundy\nTurtleneck") },
  { name:"Teal Printed Blouse",             category:"top",         type:"blouse",       color:"teal",      purchasePrice:2599,  size:"S",         brand:"W",           description:"Vibrant teal print. Office & casual.",                                             imageUrl: ph("0d9488","Teal\nPrinted Blouse") },
  { name:"Gold Sequin Top",                 category:"top",         type:"blouse",       color:"gold",      purchasePrice:3499,  size:"M",         brand:"AND",         description:"Sequin party top. New Year & celebrations.",                                       imageUrl: ph("fbbf24","Gold\nSequin Top") },
  // ── MORE BOTTOMS ──────────────────────────────────────────────────────
  { name:"Emerald Satin Skirt",             category:"bottom",      type:"skirt",        color:"green",     purchasePrice:4499,  size:"M",         brand:"Mango",       description:"Luxe satin midi skirt. Parties & events.",                                         imageUrl: ph("065f46","Emerald\nSatin Skirt") },
  { name:"Grey Joggers",                    category:"bottom",      type:"joggers",      color:"gray",      purchasePrice:2499,  size:"L",         brand:"Adidas",      description:"Comfortable joggers. Gym & casual.",                                               imageUrl: ph("6b7280","Grey\nJoggers") },
  { name:"Cream Linen Trousers",            category:"bottom",      type:"trousers",     color:"cream",     purchasePrice:3499,  size:"M",         brand:"Fabindia",    description:"Breathable linen trousers. Summer office wear.",                                   imageUrl: ph("fef3c7","Cream\nLinen Trousers") },];
